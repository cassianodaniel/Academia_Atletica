...
int main()
{
    ...
    while (1)
    {
        ...
        p->JaneiroPago = JaneiroPago2;

        arquivo >> FevereiroPago2;
        p->FevereiroPago = FevereiroPago2;

        arquivo >> MarcoPago2;
        p->MarcoPago = MarcoPago2;

        arquivo >> AbrilPago2;
        p->AbrilPago = AbrilPago2;

        arquivo >> MaioPago2;
        p->MaioPago = MaioPago2;

        arquivo >> JunhoPago2;
        p->JunhoPago = JunhoPago2;

        arquivo >> JulhoPago2;
        p->JulhoPago = JulhoPago2;

        arquivo >> AgostoPago2;
        p->AgostoPago = AgostoPago2;

        arquivo >> SetembroPago2;
        p->SetembroPago = SetembroPago2;

        arquivo >> OutubroPago2;
        p->OutubroPago = OutubroPago2;

        arquivo >> NovembroPago2;
        p->NovembroPago = NovembroPago2;

        arquivo >> DezembroPago2;
        p->DezembroPago = DezembroPago2;
